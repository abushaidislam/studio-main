...
const project = {
  ...
  process: [
    { phase: "Data Audit", duration: "8 weeks", details: "Mapped 40+ data sources, assessed data quality, identified integration patterns, created data governance framework" },
    { phase: "Architecture", duration: "6 weeks", details: "Designed data pipeline architecture, selected ML models, defined API contracts, established security protocols" },
    { phase: "Development", duration: "48 weeks", details: "Built data pipelines, implemented ML models, created analytics dashboards, developed alert system, integrated with 15 ERPs" },
    { phase: "Training", duration: "8 weeks", details: "Trained 300+ employees, created documentation, established support processes, configured custom alerts" }
  ],
  results: [
    "$45M annual cost savings achieved",
    "94% demand forecasting accuracy",
    "30% reduction in delivery times",
    "25% decrease in inventory costs",
    "2.5TB data processed daily",
    "ROI of 340% in first year"
  ],
  keyMetrics: [
    { label: "Forecast Accuracy", value: "94%", change: "+28%" },
    { label: "Cost Savings", value: "$45M", change: "Year 1" },
    { label: "Delivery Time", value: "-30%", change: "Faster" },
    { label: "Data Volume", value: "2.5TB", change: "Daily" }
  ],
  testimonial: {
    ...
    author: "James Park",
    role: "Chief Supply Chain Officer, GlobalTrade",
    company: "GlobalTrade Solutions"
  },
  technologies: ["Python", "TensorFlow", "Apache Spark", "React", "Node.js", "Snowflake", "AWS", "Kubernetes"],
  tags: ["AI/ML", "Analytics", "Enterprise", "Big Data"],
  image: imageMeeting,
  awards: ["Best Enterprise AI Solution 2024"]
};
