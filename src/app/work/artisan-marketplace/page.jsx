...
const project = {
  ...
  description: "Built a global multi-vendor marketplace connecting 15,000+ artisans from 45 countries with customers worldwide. The platform handles $50M+ in annual GMV with features like real-time inventory, automated logistics, and AI-powered product recommendations.",
  shortDescription: "Multi-vendor marketplace connecting 15,000+ artisans worldwide",
  challenge: "Artisan Market needed to scale from a small local platform to a global marketplace. They faced challenges with vendor onboarding, payment processing across 20+ currencies, complex shipping logistics, and creating trust between buyers and sellers who spoke different languages.",
  solution: "We built a comprehensive marketplace platform with automated vendor verification, multi-currency payment processing, integrated logistics APIs, real-time translation, and an AI-powered recommendation engine that increased cross-sell by 35%.",
  process: [
    { phase: "Discovery", duration: "6 weeks", details: "Vendor interviews across 12 countries, buyer behavior analysis, payment regulation research, logistics partner evaluation" },
    { phase: "Design", duration: "12 weeks", details: "Designed vendor dashboard, buyer experience, mobile apps, admin tools, created component library" },
    { phase: "Development", duration: "40 weeks", details: "Built marketplace engine, payment infrastructure, recommendation system, vendor tools, analytics dashboard" },
    { phase: "Launch", duration: "8 weeks", details: "Phased rollout by region, vendor training program, marketing campaign coordination, performance monitoring" }
  ],
  results: [
    "$50M+ annual GMV achieved",
    "15,000+ active vendors onboarded",
    "850,000+ registered buyers",
    "4.9/5 average app store rating",
    "35% increase in average order value",
    "12% vendor churn rate (industry avg: 25%)"
  ],
  keyMetrics: [
    { label: "Monthly GMV", value: "$4.2M", change: "+280%" },
    { label: "Active Vendors", value: "15,000+", change: "+400%" },
    { label: "Conversion Rate", value: "8.5%", change: "+125%" },
    { label: "Customer LTV", value: "$340", change: "+65%" }
  ],
  testimonial: {
    quote: "The platform has transformed our business. We went from struggling with manual processes to a fully automated global marketplace. Our artisans now have access to customers they never could have reached before.",
    author: "Sarah Rodriguez",
    role: "CEO & Founder, Artisan Market",
    company: "Artisan Market"
  },
  technologies: ["Next.js", "Node.js", "Stripe Connect", "MongoDB", "Elasticsearch", "AWS", "Redis", "Docker"],
  tags: ["E-commerce", "Marketplace", "Fintech", "Global"],
  image: imageMeeting,
  awards: ["Best Marketplace Platform 2023"]
};
...
export default ArtisanMarketplacePage;
